 ...
 * Toggle Page Lock
 *
 * @generated from message api.v1.TogglePageLockRequest
 */
export class TogglePageLockRequest extends Message<TogglePageLockRequest> {
  /**
   * @generated from field: string page_name = 1;
   */
  pageName = "";
  ...
  constructor(data?: PartialMessage<TogglePageLockRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.TogglePageLockRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "page_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "passphrase", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TogglePageLockRequest {
    return new TogglePageLockRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TogglePageLockRequest {
    return new TogglePageLockRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TogglePageLockRequest {
    return new TogglePageLockRequest().fromJsonString(jsonString, options);
  }

  static equals(a: TogglePageLockRequest | PlainMessage<TogglePageLockRequest> | undefined, b: TogglePageLockRequest | PlainMessage<TogglePageLockRequest> | undefined): boolean {
    return proto3.util.equals(TogglePageLockRequest, a, b);
  }
}

/**
 * @generated from message api.v1.TogglePageLockResponse
 */
export class TogglePageLockResponse extends Message<TogglePageLockResponse> {
  /**
   * @generated from field: bool success = 1;
   */
  success = false;
  ...
  constructor(data?: PartialMessage<TogglePageLockResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.TogglePageLockResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "success", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "error", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TogglePageLockResponse {
    return new TogglePageLockResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TogglePageLockResponse {
    return new TogglePageLockResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TogglePageLockResponse {
    return new TogglePageLockResponse().fromJsonString(jsonString, options);
  }

  static equals(a: TogglePageLockResponse | PlainMessage<TogglePageLockResponse> | undefined, b: TogglePageLockResponse | PlainMessage<TogglePageLockResponse> | undefined): boolean {
    return proto3.util.equals(TogglePageLockResponse, a, b);
  }
}
